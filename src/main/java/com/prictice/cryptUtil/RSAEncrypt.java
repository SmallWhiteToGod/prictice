...
public class RSAEncrypt {
    ...
    public static void genKeyPair(String filePath) {
        ...
        try {
            // 得到公钥字符串
            String publicKeyString = RSABase64.encode(publicKey.getEncoded());
            // 得到私钥字符串
            String privateKeyString = RSABase64.encode(privateKey.getEncoded());
            // 将密钥对写入到文件
    ...
    public static RSAPublicKey loadPublicKeyByStr(String publicKeyStr) throws Exception {
        try {
            byte[] buffer = RSABase64.decode(publicKeyStr);
    ...
    public static RSAPrivateKey loadPrivateKeyByStr(String privateKeyStr) throws Exception {
        try {
            byte[] buffer = RSABase64.decode(privateKeyStr);
