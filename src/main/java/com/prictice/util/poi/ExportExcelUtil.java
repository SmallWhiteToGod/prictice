...
import com.prictice.util.other.DateUtil;
...
public class ExportExcelUtil {
	...
	private static final SimpleDateFormat FORMAT = new SimpleDateFormat(DateUtil.DATE_FULL_STR);
	...
	public void setCell(final int index, final Calendar value) {
		...
		final CellStyle cellStyle = workbook.createCellStyle(); // 建立新的cell样式
		final DataFormat format = workbook.createDataFormat();
		cellStyle.setDataFormat(format.getFormat(DateUtil.DATE_FULL_STR)); // 设置cell样式为定制的日期格式
